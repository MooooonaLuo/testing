      ...
      for (var j = 0; j < data.length; j++)
      {
        if (input[i] == data[j]["title"]) {
          ...
          for(var ingre = 0; ingre < output["ingredient"].length; ingre++)
          {
            ...
            result.push(output["ingredient"][ingre]);
          }
